...
Namespace XtraGauges_CustomDraw
    ...
    Public Partial Class Form1
        ...
        Private Sub arcScaleBackgroundLayerComponent1_CustomDrawElement(ByVal sender As Object, ByVal e As CustomDrawElementEventArgs)
        ...
        Private Sub arcScaleNeedleComponent1_CustomDrawElement(ByVal sender As Object, ByVal e As CustomDrawElementEventArgs)
            If enableCustomDraw Then
        ...
        Private Sub arcScaleComponent1_CustomDrawElement(ByVal sender As Object, ByVal e As CustomDrawElementEventArgs)
            If enableCustomDraw Then e.Handled = True
        End Sub
        ...
        Private Sub OnTimerTick(ByVal sender As Object, ByVal e As EventArgs)
            If animationLockCounter > 0 Then Return
